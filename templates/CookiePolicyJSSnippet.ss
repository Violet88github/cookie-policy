...
deferJQ(function () {
require([
'_resources/silverstripe-gdpr-cookie-policy-master/javascript/jquery.cookie.min.js'
], function(cookie) {
require([
'_resources/silverstripe-gdpr-cookie-policy-master/javascript/jquery.policy.min.js'
], function (policy) {
jQuery('body').cookieNotify($config.RAW);
});
});
...
injectPolicyScript('_resources/silverstripe-gdpr-cookie-policy-master/javascript/jquery.cookie.policy.min.js');
}
}
